    ...
    public partial class donor : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    string query = string.Format("insert into DonorTable values('" + textBox1.Text + "','" + textBox2.Text + "','" + comboBox1.SelectedItem.ToString() + "','" + textBox3.Text + "','" + textBox4.Text + "','" + comboBox3.SelectedItem.ToString() + "')");
                    SERVER.INSERT(query);
                    MessageBox.Show("DONOR SUCESSFULLY SAVED");
                    Reset();
                }
                catch(Exception ex)
                {
